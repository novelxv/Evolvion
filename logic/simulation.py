...
def run_simulation(config):
    ...
    try:
        ...
        agent1 = BaseAgent(config["world_size"][0] // 2 - 50, config["world_size"][0] // 2 - 50, config, env, "prey")
        agent2 = BaseAgent(config["world_size"][0] // 2, config["world_size"][0] // 2, config, env, "base_agent")
